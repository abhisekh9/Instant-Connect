...
const MessageContainer = () => {
  ...
  return (
    <div className='flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full'>
      ...
      <div ref={scrollRef} />
      {
        showImage && <div className='fixed z-[10] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col '>
          <div>
            <img
              src={`${HOST}/${imageURL}`}
